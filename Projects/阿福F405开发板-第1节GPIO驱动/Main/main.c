...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //初使化gpio引脚
    wGpio_putInit(&led_CSS,GPIO_Pin_RUN,GPIO_MODE_OUTPUT_PP,GPIO_NOPULL,GPIO_SPEED_FREQ_MEDIUM,wLow);
    
    //初使化继电器
    wGpio_putInit(&relay_CSS,GPIO_Pin_Y10,GPIO_MODE_OUTPUT_PP,GPIO_NOPULL,GPIO_SPEED_FREQ_MEDIUM,wLow);
    
    wGpio_putWrite(&relay_CSS,Set_ACTIVE);//打开继电器
    
	while (1)
    {  
        wGpio_putWrite(&led_CSS,Set_CHANGE);//切换电平
        OSTimeDly (500,OS_OPT_TIME_DLY,&oserr); 
    }	
}
