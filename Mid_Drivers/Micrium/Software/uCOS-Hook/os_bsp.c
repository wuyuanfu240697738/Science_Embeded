...
#define  CPU_BIT_DEM_CR_TRCENA                    (1 << 24)

#define  CPU_BIT_DWT_CR_CYCCNTENA                 (1 <<  0)
...
{
    return ((CPU_INT32U)CPU_REG_DWT_CYCCNT);
}
#endif
...
void  CPU_TS_TmrInit (void)
{
    ...
    cpu_clk_freq_hz = wSys_GetClkFreq();
...
{
    return ((CPU_TS_TMR)CPU_REG_DWT_CYCCNT);
}
#endif
